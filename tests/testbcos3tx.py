...
bcossdk.bcos_sdk_create_signed_transaction(key_pair, group_id, chain_id,
                                            contract_address.encode("UTF-8"), functiondata.encode("UTF-8"),b"",blocklimit,0,
...
bcossdk.bcos_rpc_call(bcossdk.sdk, group_id, b"", contract_address.encode("UTF-8"),reqdata.encode("UTF-8"),  cb_func, byref(cb_context));
cbfuture.wait()
cbfuture.display()
