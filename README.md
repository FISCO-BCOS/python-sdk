...
后缀名为.sol的solidity合约代码文件，可用solc.py结合solc二进制编译器进行编译，或采用fisco-bcos的控制台，[对合约sol代码文件进行编译](https://fisco-bcos-documentation.readthedocs.io/zh_CN/latest/docs/tutorial/sdk_application.html?highlight=%E7%BC%96%E8%AF%91#id7)
