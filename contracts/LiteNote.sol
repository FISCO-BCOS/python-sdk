...
contract LiteNote{
    ...
    function read(uint256 index) public view returns (string,string,string)
    {
    ...
    function write(string timestamp,string title,string content) public returns (uint256) {
	if(isPublic == false)
	{
