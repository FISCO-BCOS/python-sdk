...
class console_account:
    ...
    def create_gm_account(name, password):
    ...
    def create_ecdsa_account(name, password):
...
if False:
    cname = "console_account"
    acc = globals()[cname]
    #console_run(acc, ["create", "tester", "123456"])
    #console_run(acc, ["list"])
    console_run(acc, ["usage"])
